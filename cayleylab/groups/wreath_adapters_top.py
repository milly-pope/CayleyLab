# Top (acting) group adapters for D in wreath products C wr D. This defines movement along the base group
# Each adapter provides: identity, multiply, inverse, pretty, default_gens, parse_word.
# We define these functions as top is used to update head position
